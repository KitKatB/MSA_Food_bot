...
exports.displayNutritionCards = function getNutritionData(foodName, session){
    var url = "https://api.nal.usda.gov/ndb/search/?format=json&q="+foodName+"&sort=r&max=1&offset=0&api_key=JfYK0BVKStC94aGCGeFClKeCNWco1EvGnoC7U84k";
    //check and get food in database if it exists
...
function getFoodNutrition(message, foodName, session){
    ...
    var url = "https://api.nal.usda.gov/ndb/reports/?ndbno="+ndbno+"&type=f&format=json&api_key=JfYK0BVKStC94aGCGeFClKeCNWco1EvGnoC7U84k";
